...
public class SendDataController extends BaseController {
    ...
    public ResponseEntity<Map<String, Object>> getInitialInfo(HttpServletRequest request) {
        ...
        opt1.put("","");
        opt2 = new HashMap<>();
        opt2.put("0","低123123低123123低123123低123123低123123低123123低123123低123123低123123低123123低123123低123123低123123低123123低123123低123123低123123");
        opt3 = new HashMap<>();
        opt3.put("1","高567567");
        options.add(opt1);
        options.add(opt2);
...
//        Map<String, Object> result = g_servicePageItem.getPageItemByMenuCd("m1_1");
